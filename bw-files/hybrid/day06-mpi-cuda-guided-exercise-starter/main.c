...
// Include library with host functions for CUDA
#include "add-vectors.h"
...
//christina commenting this out because these are all CUDA related
//macros that are included in another file.
*/
...
/*
christina commenting this out. b/c CUDA related
...
int main(int argc, char ** argv)
{
  ...
  */
  ...
  // christina adding this instead of lines above.
  InitDeviceMemory();
  ...
  /*
  //christina removing this b/c CUDA related
  ...
  */
  ...
  //christina added this to replace above lines
  AddVectorsOnDevice();
  ...
  /*
  //christina removed this b/c CUDA related
...
/*
//christina removed this because it was CUDA related
