...
//matrix multiply naieve version
double matrix_mult_naieve(double** matX, double** matY, double** matZ);
...
int main (int argc, char **argv){
    ...
    {
        case 1:
            matrix_mult_naieve(matX, matY, matZ);
            break;
        case 2:
...
double matrix_mult_naieve(double** matX, double** matY, double** matZ){
    int i, j, k;
    printf("|---This is naieve matrix multiply---|\n");
